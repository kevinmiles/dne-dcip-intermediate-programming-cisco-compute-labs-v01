...
Explore UCS Python SDK Metadata, data about the UCS Manger Objects.
  ...
  1. Launch the Python shell by ***double-clicking*** the **Terminal for Coding** icon on the Desktop.
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-01.jpg)<br/><br/>
  ...
  2. At the prompt type:
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-02.jpg)<br/><br/>
  ...
  The output from this code provides a great deal of information. At the very top of the output is the Object Model tree structure showing where a UCS VLAN object is contained and what children objects the VLAN Object contains.
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-03.jpg)<br/><br/>
  ...
  Following the Object Model tree is metadata about the object class
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-04.jpg)<br/><br/>
  ...
  4. Accessing the data is a combination of (.) dot accessors and array [] indexing. The first thing to do is look at the variable `meta` itself, at the prompt type:
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-05.jpg)<br/><br/>
  ...
  ```
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-06.jpg)<br/><br/>
  ...
  6. Access the Object Property Metadata, let's look two properties in particular `name` and `id`, at the prompt type:
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-07.jpg)<br/><br/>
  ...
  To see the Restrictions, at the prompt type:
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-08.jpg)<br/><br/>
  ...
  Want to see every VLAN Object Attribute, with its' associated, pattern, value_set, or range_val, at the prompt type:
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-09.jpg)<br/><br/>
  ...
  Retrieve the VLAN Name and Id attribute's pattern and range_val restrictions, at the prompt type:
    ...
    ![](/posts/files/dne-dcip-intermediate-programming-cisco-compute-ucs-python-sdk-v01/assets/images/image-10.jpg)<br/><br/>

    ![](assets/images/image-10.jpg)<br/><br/>-->

  UCS Object Metadata is a powerful component of UCS Python SDK, methods show here can be used for any Object in the UCS Object Model.

Next Step: UCS Transactions.

***Code Sample*** - exercise-1.py

Launch the Python shell and connect to a UCS Manager and Disconnect from a UCS Manager.

  1. Launch the Python shell by ***double-clicking*** the **Terminal for Coding** icon on the Desktop.

  Terminal for Coding Icon:
  ...
  Connecting to a USC Manager requires a UcsHandle object be instantiated. Once instantiated the login() and logout() methods are used to connect and disconnect from the UCS.

  3. Import the Python module for a UcsHandle object and instantiate a UcsHandle object; at the prompt type:
  ...
  4. Using the login() method in the UcsHandle object, connect to the UCS Manager. At the prompt type:

    `handle.login()`

  If all goes well, the python shell responds with **True**.

  UcsHandle Object Instantiate and Connect:
