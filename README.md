# Cisco DevNet Learning Labs: DevNet Express Data Center Infrastructure Programmability Intermediate Programming Cisco Compute

These self-paced interactive tutorials provide instructions for developers to learn PowerTool and PowerShell, and use XML APIs and Python.
...
* Use your knowledge of PowerTool with PowerShell.
* Learn and use UCS XML API.
* Learn and use Python.
* Learn and use XML API.
